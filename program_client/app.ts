...
import {
    burnSendAndConfirm,
    CslSplTokenPDAs,
    deriveDigitalArtMetadataPDA,
    getDigitalArtMetadata,
    initializeClient,
    mintSendAndConfirm,
...
async function main(feePayer: Keypair) {
    ...
    /**
     * Derive the DigitalArt Metadata so we can retrieve it later
     */
    const [DigitalArtPub] = deriveDigitalArtMetadataPDA(
        {
            mint: mint.publicKey,
        },
        progId,
    );
    console.info("+==== DigitalArt Metadata Address ====+");
    console.info(DigitalArtPub.toBase58());
    ...
    await mintSendAndConfirm({
        ...
        title:"Monalisa",
        artist:"Da vinchi",
        description:"A girl with a rare smile and no eyebrows",
        imageUrl:"https://en.wikipedia.org/wiki/File:Mona_Lisa.jpg",
        signers: {
            feePayer: feePayer,
            funding: feePayer,
            mint: mint,
    ...
    /**
     * Get the DigitalArt Metadata
     */
    let DigitalArt = await getDigitalArtMetadata(DigitalArtPub);
    console.info("+==== DigitalArt Metadata ====+");
    console.info(DigitalArt);
    console.assert(DigitalArt!.assocAccount!.toBase58(), johnDoeATA.toBase58());
     ...
     * Get the DigitalArt Metadata
     */
    DigitalArt = await getDigitalArtMetadata(DigitalArtPub);
    console.info("+==== DigitalArt Metadata ====+");
    console.info(DigitalArt);
    console.assert(DigitalArt!.assocAccount!.toBase58(), janeDoeATA.toBase58());
    ...
    console.info("+==== DigitalArt Metadata ====+");
    console.info(DigitalArt);
    console.assert(typeof DigitalArt!.assocAccount, "undefined");
}
