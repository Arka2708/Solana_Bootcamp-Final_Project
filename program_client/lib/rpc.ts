...
export const mint = (args: MintArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: MyDigitalArtNftInstruction.Mint,
            title: args.title,
            artist: args.artist,
    ...
    const [digitalArtPubkey] = pda.deriveDigitalArtMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: digitalArtPubkey, isSigner: false, isWritable: true},
...
export const transfer = (args: TransferArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: MyDigitalArtNftInstruction.Transfer,
        }
    );
...
export const burn = (args: BurnArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: MyDigitalArtNftInstruction.Burn,
        }
    );
...
export const getDigitalArtMetadata = async (
    publicKey: PublicKey,
    commitmentOrConfig: Commitment | GetAccountInfoConfig | undefined = "processed"
): Promise<T.DigitalArtMetadata | undefined> => {
    ...
    return T.decodeDigitalArtMetadata(deserialize(T.DigitalArtMetadataSchema, buffer.data) as Record<string, unknown>);
}
